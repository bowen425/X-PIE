...
protocol.initStruct('input/p26641-prepare.psf',erase=False)
protocol.initCoords('input/p26641-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/p24534-prepare.psf',erase=False)
protocol.initCoords('input/p24534-prepare.pdb')
AtomSel("all and not (segid ALT1)").apply( SetProperty('segmentName', 'BLT1') )
protocol.initStruct('input/p29692-prepare.psf',erase=False)
protocol.initCoords('input/p29692-prepare.pdb')
AtomSel("all and not (segid ALT1 or segid BLT1)").apply( SetProperty('segmentName', 'CLT1') )
protocol.initStruct('input/p68104-prepare.psf',erase=False)
protocol.initCoords('input/p68104-prepare.pdb')
AtomSel("all and not (segid ALT1 or segid BLT1 or segid CLT1)").apply( SetProperty('segmentName', 'DLT1') )
...
command("""
    ...
    inter = (segid ALT1)(segid CLT1)
    inter = (segid ALT1)(segid DLT1)
    inter = (segid BLT1)(segid CLT1)
    inter = (segid BLT1)(segid DLT1)
    inter = (segid CLT1)(segid DLT1)
    inter = (segid ALT1 and resid 1:228)(segid ALT1 and resid 290:437)
    inter = (segid ALT1 and resid 229:289)(all)
    inter = (segid BLT1 and resid 129:135)(all)
    inter = (segid CLT1 and resid 189:193)(all)
    weights * 1 end end
...
dyn.fix(""" segid ALT1 and resid 290:437 """)
dyn.group(""" segid ALT1 and resid 1:228 """)
dyn.group(""" segid BLT1 and not (resid 129:135) """)
dyn.group(""" segid CLT1 and not (resid 189:193) """)
dyn.fix(""" segid DLT1 """)
...
StructureLoop(numStructures=480,
              pdbTemplate='./output3/Calc_STRUCTURE.pdb',
