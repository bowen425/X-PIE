...
protocol.initStruct('input/e2-prepare.psf',erase=False)
protocol.initCoords('input/e2-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/ub-prepare.psf',erase=False)
protocol.initCoords('input/ub-prepare.pdb')
