...
protocol.initStruct('input/7k5x-a-prepare.psf',erase=False)
protocol.initCoords('input/7k5x-a-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/7k5x-b1-prepare.psf',erase=False)
protocol.initCoords('input/7k5x-b1-prepare.pdb')
...
pot.setAveType("sum")
noe.append(pot)
rampedParams.append( MultRamp(0.5,30, "noe.setScale( VALUE )") )
