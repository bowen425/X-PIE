...
protocol.initStruct('input/p22626-prepare.psf',erase=False)
protocol.initCoords('input/p22626-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/p61599-prepare.psf',erase=False)
protocol.initCoords('input/p61599-prepare.pdb')
