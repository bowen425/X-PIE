...
protocol.initStruct('input/p04406-prepare.psf',erase=False)
protocol.initCoords('input/p04406-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/p09874-prepare.psf',erase=False)
protocol.initCoords('input/p09874-prepare.pdb')
...
command("""
    ...
    inter = (segid ALT1 and resid 250:254)(all)
    inter = (segid BLT1 and resid 203:207)(all)
    weights * 1 end end
...
dyn.fix(""" segid ALT1 and not (resid 250:254) """)
dyn.group(""" segid BLT1 and not (resid 203:207) """)
