...
protocol.initStruct('input/p62750-prepare.psf',erase=False)
protocol.initCoords('input/p62750-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/p63167-prepare.psf',erase=False)
protocol.initCoords('input/p63167-prepare.pdb')
...
command("""
    ...
    inter = (segid ALT1 and resi 33:37)(all)
    weights * 1 end end
...
dyn.fix("""segid ALT1 and not (resid 33:37)""")
