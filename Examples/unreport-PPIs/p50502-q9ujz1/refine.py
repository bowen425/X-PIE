...
protocol.initParams('/home/gz/opt/xplor-nih-3.10/toppar/parallhdg_new.pro')
protocol.initStruct('input/p05052-prepare.psf',erase=False)
protocol.initCoords('input/p05052-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/q9ujz1-prepare.psf',erase=False)
protocol.initCoords('input/q9ujz1-prepare.pdb')
...
command("""
    ...
    inter = (segid ALT1 and resid 1:39)(segid ALT1 and resid 108:369)
    inter = (segid ALT1 and resid 40:107)(all)
    inter = (segid BLT1 and resid 1:36)(all)
    weights * 1 end end
...
dyn.group(""" segid ALT1 and resid 1:39 """)
dyn.fix(""" segid ALT1 and resid 108:369 """)
dyn.group(""" segid BLT1 and not (resid 1:36) """)
...
StructureLoop(numStructures=24,
