...
protocol.initStruct('input/p12277-prepare.psf',erase=False)
protocol.initCoords('input/p12277-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/p84098-prepare.psf',erase=False)
protocol.initCoords('input/p84098-prepare.pdb')
