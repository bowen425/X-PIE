...
protocol.initStruct('input/o75347-prepare.psf',erase=False)
protocol.initCoords('input/o75347-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/q9ubt2-prepare.psf',erase=False)
protocol.initCoords('input/q9ubt2-prepare.pdb')
