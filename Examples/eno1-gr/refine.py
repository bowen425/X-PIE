...
protocol.initStruct('input/eno1-prepare.psf',erase=False)
protocol.initCoords('input/eno1-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/gr-prepare.psf',erase=False)
protocol.initCoords('input/gr-prepare.pdb')
...
StructureLoop(numStructures=24,
              pdbTemplate='./output2/Calc_STRUCTURE.pdb',
