...
protocol.initStruct('input/6y53-b-prepare.psf',erase=False)
protocol.initCoords('input/6y53-b-prepare.pdb')
AtomSel("all").apply( SetProperty('segmentName', 'ALT1') )
protocol.initStruct('input/6y53-a1_ambH.psf',erase=False)
protocol.initCoords('input/6y53-a1_ambH.pdb')
